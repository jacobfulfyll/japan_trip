...
test('CACHE_VERSION is v40 (TEMP: shift trip dates to start Jun 1 for live photo-feature testing — data/days.js shell change; revert after testing)', () => {
  ...
  assert.equal(CACHE_VERSION, 'v40');
});
